...
@section('content')
    <div class="pb-3 mb-3">
        <a href="{{ route('education.index') }}" class="btn btn-info float-end">Kembali</a>
    </div>
    <form action="{{ route('education.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm" name="judul" id="judul" aria-describedby="helpId"
                placeholder="Masukan Universitas" value="{{ Session::get('judul') }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm" name="info1" id="info1"
                aria-describedby="helpId" placeholder="Masukan Nama Fakultas" value="{{ Session::get('info1') }}">
        </div>
        <div class="mb-3">
            <label for="info2" class="form-label">Nama Prodi</label>
            <input type="text" class="form-control form-control-sm" name="info2" id="info2"
                aria-describedby="helpId" placeholder="Masukan Nama Fakultas" value="{{ Session::get('info2') }}">
        </div>
        <div class="mb-3">
            <label for="info3" class="form-label">IPK</label>
            <input type="text" class="form-control form-control-sm" name="info3" id="info3"
                aria-describedby="helpId" placeholder="Masukan Nama Fakultas" value="{{ Session::get('info3') }}">
        </div>
        <div class="mb-3">
            <div class="row">
