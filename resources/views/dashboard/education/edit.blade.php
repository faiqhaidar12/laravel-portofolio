    ...
    <form action="{{ route('education.update', $data->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm" name="judul" id="judul" aria-describedby="helpId"
                placeholder="Masukan Universitas" value="{{ $data->judul }}">
        </div>
        <div class="mb-3">
