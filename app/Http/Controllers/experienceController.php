...
class experienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'judul.required' => 'Judul wajib diisi yaa!',
                'info1.required' => 'Nama Perusahaan wajib diisi yaa!',
                'tgl_mulai.required' => 'Tanggal mulai wajib diisi yaa!',
                'isi.required' => 'Isian wajib diisi juga yaa!'
            ]
        );
